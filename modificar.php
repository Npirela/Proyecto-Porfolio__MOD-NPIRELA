...
if($_POST){
    ...
    $conexion = new conexion();
    $sql = "UPDATE `proyectos` SET `nombre` = '$nombre_proyecto' , `imagen` = '$imagen', `descripcion` = '$descripcion', `link` = '$link' WHERE `proyectos`.`id` = '$id';";
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <textarea required class="form-control" name="link" id="link" cols="30" rows="4"><?php echo $fila['link'];?></textarea>
                            </div>
                            <div>
                            <br>
